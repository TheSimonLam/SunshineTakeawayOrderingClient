export default [
  {
    ...
    items: [
      ...
      { id: "", name: "Cheese & Onion fry it", price: 1.2 },
      { id: "", name: "Large Spring Roll", price: 2.2 },
      {
        id: "",
        name: "Mini Spring Rolls (5) with sweet & sour sauce",
        price: 3.1,
      },
      { id: "", name: "Chicken Breast", price: 3.3 },
      { id: "", name: "Onion Rings", price: 2.8 },
      { id: "", name: "Buttered bap", price: 0.5 },
      { id: "", name: "Chip bap", price: 2.2 },
      { id: "", name: "Scallop Bap", price: 1.0 },
      { id: "", name: "Beef Burger in a Bun with Salad & Relish", price: 2.95 },
      { id: "", name: "Cheeseburger in a Bun with Salad & Relish", price: 3.1 },
      { id: "", name: "Chicken Sandwich with Mayonnaise", price: 3.1 },
      { id: "", name: "Battered Burger Bap", price: 2.9 },
      { id: "", name: "Jumbo Sausage Bap", price: 1.9 },
      { id: "", name: "Chips and Curry", price: 2.9 },
      { id: "", name: "Chips and Gravy", price: 2.9 },
      { id: "", name: "Boiled Rice, Chips, & Curry", price: 3.9 },
      { id: "", name: "Fried Rice, Chips, & Curry", price: 4.5 },
      { id: "", name: "Sausage (2), Chips, Peas & Gravy", price: 4.3 },
      { id: "", name: "Pie, Chips, Peas and Gravy", price: 4.1 },
      { id: "", name: "Chicken Nuggets & Chips", price: 3.6 },
    ],
  },
  {
  ...
  {
    description:
      "Includes Chips & Peas. Onions & Gravy included where appropriate",
    name: "English",
    items: [
      {
        id: 221,
