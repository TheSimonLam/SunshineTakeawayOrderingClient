export default [
  {
    ...
    items: [
      ...
      { id: "", name: "Cheese & Onion fry it", price: 1.7 },
      ...
      { id: "", name: "Chicken Breast", price: 4.2 },
      { id: "", name: "Onion Rings", price: 3.9 },
      { id: "", name: "Buttered bap", price: 0.7 },
      { id: "", name: "Chip bap", price: 3.0 },
      { id: "", name: "Scallop Bap", price: 1.4 },
      { id: "", name: "Beef Burger in a Bun with Salad & Relish", price: 3.6 },
      { id: "", name: "Cheeseburger in a Bun with Salad & Relish", price: 3.7 },
      { id: "", name: "Chicken Sandwich with Mayonnaise", price: 3.7 },
      { id: "", name: "Battered Burger Bap", price: 3.7 },
      { id: "", name: "Jumbo Sausage Bap", price: 2.9 },
      { id: "", name: "Chips and Curry", price: 4.0 },
      { id: "", name: "Chips and Gravy", price: 4.0 },
      { id: "", name: "Boiled Rice, Chips, & Curry", price: 5.6 },
      { id: "", name: "Fried Rice, Chips, & Curry", price: 6.1 },
      { id: "", name: "Sausage (2), Chips, Peas & Gravy", price: 5.9 },
      { id: "", name: "Chicken Nuggets & Chips", price: 4.8 },
    ],
  },
  {
